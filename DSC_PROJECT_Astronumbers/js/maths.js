...
var signs = ["+", "/", "-", "x"]
facts = ["SPACE IS COMPLETELY SILENT.THE HOTTEST PLANET IN OUR SOLAR SYSTEM IS 450° C.", "A FULL NASA SPACE SUIT COSTS $12,000,000.THE SUN’S MASS TAKES UP 99.86% OF THE SOLAR SYSTEM.",
  "THE SUN’S MASS TAKES UP 99.86% OF THE SOLAR SYSTEM.THERE ARE MORE TREES ON EARTH THAN STARS IN THE MILKY WAY",
  "THE SUNSET ON MARS APPEARS BLUE. THERE ARE MORE STARS IN THE UNIVERSE THAN GRAINS OF SANDS ON EARTH",  "ONE DAY ON VENUS IS LONGER THAN ONE YEAR.THERE IS A PLANET MADE OF DIAMONDS",
  ...
  "Red Dwarf stars that are low in mass can burn continually for up to 10 trillion years!", "A day on Mercury is equivalent to 58 Earth days.",
